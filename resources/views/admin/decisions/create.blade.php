            ...
            <div class="grid gap-6">
                ...
                <div class="flex justify-end">
                    <div class="w-full md:w-64">
                        ...
                        <x-eth-date-input name="decision_date" :value="old('decision_date', now()->toDateString())" class="mt-1" />
                        @error('decision_date')
                ...
                <!-- Judges -->
                    ...
                    <div class="grid md:grid-cols-3 gap-3">
                        ...
                        $selectedJudge = old("judges.$storageIndex.admin_user_id", $defaultJudgeId);
                        $isSessionJudge = $storageIndex === 1;
                        $isThird = $storageIndex === 2;
                        ...
                        <div>
                            ...
                            <select name="judges[{{ $storageIndex }}][admin_user_id]"
                                ...
                                <option value="" disabled>{{ __('decisions.judges.no_teammates') }}</option>
                                @endif
                            </select>
                            @endif
                        </div>
