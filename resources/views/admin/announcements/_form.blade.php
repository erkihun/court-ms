...
<div class="space-y-6">
    <div>
        ...
        <input type="text"
            ...
            class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
            maxlength="255"
        >
        @error('title')
