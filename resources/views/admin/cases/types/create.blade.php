        ...
        <form method="POST" action="{{ route('case-types.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input name="name" value="{{ old('name') }}" required
                    class="mt-1 w-full px-3 py-2 rounded-lg bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <input name="prefix" value="{{ old('prefix') }}" maxlength="16"
                    class="mt-1 w-full px-3 py-2 rounded-lg bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm">
            ...
            <div class="flex gap-2">
                ...
                <button class="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white">{{ __('Save') }}</button>
            </div>
        </form>
    </div>
</x-admin-layout>
