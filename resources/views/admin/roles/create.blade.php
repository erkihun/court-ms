<x-admin-layout title="{{ __('roles.create.title') }}">
    ...
    <div class="enterprise-page">
        ...
        <form method="POST" action="{{ route('roles.store') }}" class="admin-form-shell">
            @csrf
                ...
                <div class="admin-panel space-y-3">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            class="ui-textarea mt-1">{{ old('description') }}</textarea>
                        @error('description') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        <p class="text-xs text-gray-500 mt-1">{{ __('roles.create.description_hint') }}</p>
                    </div>
                </div>

                <div class="admin-panel-muted space-y-3">
            ...
            {{-- Permissions --}}
            <div class="admin-form-main space-y-4">
