...
<x-public-layout title="{{ __('auth.registration_title') }}">
    ...
    @endif
    <div
        class="max-w-6xl mx-auto bg-white applicant-register-card rounded-xl border border-slate-300 shadow-lg p-6 md:p-8">

        {{-- Header --}}
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                <div class="h-9 w-9 rounded-full bg-orange-50 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-orange-600" viewBox="0 0 24 24"
        ...
        <form method="POST" action="{{ route('applicant.register.submit') }}" class="space-y-6">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input name="first_name" value="{{ old('first_name') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                ...
                <div>
                    ...
                    <input name="middle_name" value="{{ old('middle_name') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
                <div>
                    <label class="block text-md font-medium text-slate-700">
                    ...
                    <input name="last_name" value="{{ old('last_name') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input name="position" value="{{ old('position') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
                <div>
                    <label class="block text-md font-medium text-slate-700">
                    ...
                    <input name="organization_name" value="{{ old('organization_name') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="gender" class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900 bg-white
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                ...
                <div>
                    ...
                    <input name="phone" value="{{ old('phone') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
                <div>
                    <label class="block text-md font-medium text-slate-700">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
                <div>
                    <label class="block text-md font-medium text-slate-700">
                    ...
                    <input name="address" value="{{ old('address') }}" required class="mt-1 w-full px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                               focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="mt-1 relative">
                        <input id="password" type="password" name="password" required class="w-full pr-10 px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                                   focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                        <button type="button"
                ...
                <div>
                    ...
                    <div class="mt-1 relative">
                        <input id="password_confirmation" type="password" name="password_confirmation" required class="w-full pr-10 px-3 py-2.5 rounded-lg border border-slate-300 text-sm text-slate-900
                                   focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                        <button type="button"
                            class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600"
