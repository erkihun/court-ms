<x-applicant-layout title="{{ __('respondent.find_case_title') }}">
    <div class="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200 shadow p-6">
        ...
        <form method="GET" action="{{ route('applicant.respondent.cases.search') }}" class="space-y-4">
        ...
        <div class="mt-6 space-y-3">
            ...
            <div class="rounded-xl border border-blue-100 bg-blue-50 p-4">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('applicant.respondent.cases.show', $case->case_number) }}" class="text-sm text-blue-700 hover:underline">{{ __('respondent.view_case_details') }}</a>
                </div>
