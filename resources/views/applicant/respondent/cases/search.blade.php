        ...
        <form method="GET" action="{{ route('respondent.case.search') }}" class="space-y-4">
            ...
            <div>
                ...
                <input id="case_code" name="case_code" value="{{ old('case_code', $caseCode ?? '') }}"
                    class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
                    placeholder="5-digit code" autocomplete="off">
            </div>
        ...
        <div class="mt-6 space-y-3">
            ...
            <div class="rounded-xl border border-blue-100 bg-blue-50 p-4">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('respondent.cases.show', ['caseNumber' => $case->case_number, 'case_code' => $caseCode]) }}" class="text-sm text-blue-700 hover:underline">{{ __('respondent.view_case_details') }}</a>
                </div>
