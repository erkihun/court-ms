...
return [
    ...
    'landing' => [
        'public_portal' => 'የህዝብ መግቢያ',
        'total_cases' => 'ጠቅላላ ጉዳዮች',
        'open_cases' => 'ክፍት ጉዳዮች',
        'pending_review' => 'በግምገማ ላይ',
        'upcoming_hearings' => 'የሚመጡ ችሎቶች',
        'admin_court_public_portal' => 'የአስተዳደር ፍርድ ቤት የህዝብ መግቢያ',
        'public_signage' => 'የህዝብ ማስታወቂያ',
        'portal_login' => 'የመግቢያ ግባ',
        'live_case_overview' => 'በመዝገብ ቤት ያሉ ጉዳዮች ቀጥታ እይታ',
        'hero_title' => 'በጨለማ ሰማያዊ እና ብርቱካናማ ምልክት የተገነባ ዘመናዊ የፍርድ ቤት መግቢያ።',
        'hero_description' => 'የቅርብ ጊዜ እንቅስቃሴዎችን ይመልከቱ፣ የጉዳይ እድገት ያረጋግጡ እና ወደ አመልካች/ተጠሪ ሥርዓት በቀጥታ ይግቡ።',
        'create_applicant_account' => 'የአመልካች አካውንት ፍጠር',
        'respondent_access' => 'የተጠሪ መግቢያ',
        'recent_filings' => 'የቅርብ ጊዜ ማቅረቦች',
        'latest_registered_cases' => 'ከሁሉም አዲስ የተመዘገቡ ጉዳዮች',
        'updated_on' => 'የተሻሻለው: :date',
        'recorded' => 'ተመዝግቧል',
        'filed_on' => 'የቀረበ: :date',
        'no_recent_cases' => 'ለማሳየት የቅርብ ጊዜ ጉዳዮች የሉም።',
        'footer_description' => 'በጨለማ ሰማያዊ እና ብርቱካናማ ምልክት የተገነባ ግልጽ የህዝብ ፍርድ ቤት መግቢያ።',
    ],

    'public_portal' => [
        'badge' => 'የህዝብ ፍርድ ቤት መግቢያ',
        'title' => 'ለህዝብ ጉዳዮች ፈጣን እና ዘመናዊ መግቢያ።',
        'description' => 'የጉዳይ ቁጥር ይፈልጉ፣ የማቅረቢያ ዝርዝር ይመልከቱ እና የህዝብ ጉዳዮች ማጠቃለያ ይክፈቱ።',
        'browse_public_cases' => 'የህዝብ ጉዳዮች ይመልከቱ',
        ...
        'search_public_cases' => 'የህዝብ ጉዳዮች ፈልግ',
    ...
    'public_cases' => [
        ...
        'title' => 'የህዝብ ጉዳዮችን ፈልግ እና ይመልከቱ።',
        'description' => 'በታች ያሉትን ማጣሪያዎች በመጠቀም የታተሙ ጉዳዮችን ያግኙ።',
        'results_shown' => 'የታዩ ውጤቶች',
        'on_this_page' => 'በዚህ ገጽ',
        'search_state' => 'የፍለጋ ሁኔታ',
        'filtered_results' => 'የተጣሩ ውጤቶች',
        'all_public_cases' => 'ሁሉም የህዝብ ጉዳዮች',
        ...
        'view_case' => 'ጉዳይ ይመልከቱ',
        'no_public_cases_found' => 'የህዝብ ጉዳዮች አልተገኙም',
