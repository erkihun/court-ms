...
return [
    'nav' => [
        ...
        'faq' => 'ተደጋጋሚ ጥያቄዎች',
        'resources' => 'ሃብቶች',
        'agency_label' => 'የፌዴራል የአስተዳደር ችሎት',
        'user_manual' => 'የተጠቃሚ መመሪያ',
    ],
    ...
    'hero' => [
        'badge' => 'የዲጂታል ጉዳይ አስተዳደር ሥርዓት',
        'title' => 'የአስተዳደር ፍትሕ አገልግሎት',
        'accent' => 'ቀላል፣ ግልጽ እና ተደራሽ',
        'description' => 'አቤቱታ ለማቅረብ፣ የጉዳይ ሂደትን ለመከታተል፣ የችሎት ቀጠሮና ውሳኔ ለማየት የተዘጋጀ የችሎቱ ይፋዊ ዲጂታል መድረክ።',
        ...
        'slides' => [
            'digital' => [
                'badge' => 'ዲጂታል ችሎት',
                'title' => 'የችሎቱ ዲጂታል የጉዳይ አስተዳደር',
                'description' => 'አቤቱታዎን በመስመር ላይ ያቅርቡ፣ አስፈላጊ ሰነዶችን ያያይዙ እና የጉዳዩን ሂደት ከአንድ ቦታ ይከታተሉ።',
                'cta_label' => 'ጉዳይ ያስገቡ',
                'secondary_label' => 'የጉዳይ ሁኔታን ይመልከቱ',
            ],
            'hearing' => [
                'badge' => 'የችሎት አመራር',
                'title' => 'የችሎት ቀጠሮዎን በቀላሉ ይከታተሉ',
                'description' => 'የችሎት ቀን፣ ሰዓትና ቦታ ይመልከቱ፤ የቀጠሮ ለውጥና ሌሎች ማሳወቂያዎችን በወቅቱ ያግኙ።',
                'cta_label' => 'ወደ መግቢያ ይሂዱ',
                'secondary_label' => 'የአጠቃቀም ውሎች',
            ],
            'analytics' => [
                'badge' => 'የጉዳይ ክትትል',
                'title' => 'የጉዳይዎን ሁኔታ በወቅቱ ይወቁ',
                'description' => 'የጉዳዩን ወቅታዊ ሁኔታ፣ የቀረቡ ሰነዶች፣ የችሎት ቀጠሮዎችና ውሳኔዎች በግል መለያዎ ይመልከቱ።',
                'cta_label' => 'የሥርዓቱን መረጃ ይመልከቱ',
                'secondary_label' => 'የአመልካች መግቢያ',
            ],
        ],
    ],
    ...
    'metrics' => [
        ...
        'section_description' => 'በሥርዓቱ የተመዘገቡ ጉዳዮችና የችሎት ቀጠሮዎች ወቅታዊ አጠቃላይ መረጃ።',
        'live_data' => 'ወቅታዊ መረጃ',
        'time_unit' => 'ቀናት',
        'resolution_card' => [
        ...
        'cards' => [
            ...
            'avg_resolution_time' => [
                'label' => 'የሚቀጥሉ የችሎት ቀጠሮዎች',
                'description' => 'ከዛሬ ጀምሮ ቀጠሮ የተያዘላቸው ችሎቶች',
            ],
        ],
    ],
    ...
    'timeline' => [
        ...
        'steps' => [
            ...
            'evidence_submission' => [
                ...
                'description' => 'ደጋፊ ሰነዶችንና ማስረጃዎችን ማቅረብ፣ የችሎት ቀጠሮ መቀበል እና በችሎቱ ፊት መቅረብ።',
                'meta' => 'የችሎት አመራር',
                'duration' => '30 ደቂቃ',
            ],
            'adjudication' => [
    ...
    'services' => [
        ...
        'cards' => [
            ...
            'online_dispute_resolution' => [
                'title' => 'ከባለጉዳዮች ጋር መገናኛ',
                'description' => 'የጉዳይ ማሳወቂያዎችን ይቀበሉ፣ የተፈቀዱ መልዕክቶችን ይለዋወጡ እና በተገቢው መግቢያ ምላሽ ይስጡ።',
                'meta' => 'የጉዳይ ግንኙነት',
                'features' => [
                    'virtual_medation' => 'የጉዳይ ማሳወቂያዎች',
                    'recording_transcription' => 'የአመልካችና የተጠሪ መግቢያ',
                    'secure_collaboration' => 'የተፈቀደ የመልዕክት ልውውጥ',
                ],
            ],
        ],
    ],
    ...
    'resources' => [
        'section_badge' => 'የችሎቱ መረጃዎች',
        'section_title' => 'ቅጾች፣ ሰነዶች እና ማሳወቂያዎች',
        'section_description' => 'በችሎቱ የታተሙ ቅጾችን፣ መመሪያዎችን፣ ሰነዶችንና ይፋዊ ማሳወቂያዎችን ያግኙ።',
        'view_all' => 'ሁሉንም መረጃዎች ይመልከቱ',
        'featured' => 'ተመራጭ',
        'download' => 'አውርድ',
        'visit' => 'ክፈት',
        'types' => [
    ...
    'faq' => [
        ...
        'questions' => [
            ...
            [
                'question' => 'በተቀጠረው ችሎት መገኘት ባልችል ምን ማድረግ አለብኝ?',
                'answer' => 'የችሎት ቀጠሮዎን በግል መለያዎ ያረጋግጡ። መቅረብ የማይችሉ ከሆነ ከቀጠሮው በፊት ምክንያትዎን በማስረጃ አስደግፈው ለችሎቱ መዝገብ ቤት ያሳውቁ።',
            ],
            [
