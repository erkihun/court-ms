...
return [
    ...
    'landing' => [
        ...
        'admin_court_public_portal' => 'Administrative Court Public Portal',
        'public_signage' => 'Public signage',
        'portal_login' => 'Portal login',
        'live_case_overview' => 'Live case overview from the court registry',
        'hero_title' => 'Trusted, modern court access with a dark-blue and orange identity.',
        'hero_description' => 'Browse recent activity, verify case progress, and move directly into the applicant and respondent workflows with a cleaner interface.',
        'create_applicant_account' => 'Create applicant account',
        'respondent_access' => 'Respondent access',
        'recent_filings' => 'Recent filings',
        'latest_registered_cases' => 'Latest registered cases',
        'updated_on' => 'Updated :date',
        'recorded' => 'Recorded',
        'filed_on' => 'Filed :date',
        'no_recent_cases' => 'No recent cases are available to display yet.',
        'footer_description' => 'Dark-blue and orange branded interface for clear public court access.',
    ],

    'public_portal' => [
        'badge' => 'Court public portal',
        'title' => 'Fast, modern access to public court case information.',
        'description' => 'Search case numbers, review filing details, and open public case summaries from a cleaner, easier-to-scan experience built for applicants, respondents, and visitors.',
        'browse_public_cases' => 'Browse public cases',
        'applicant_sign_in' => 'Applicant sign in',
        'case_lookup' => 'Case lookup',
        'case_lookup_text' => 'Find public records with case number, title, court, or type.',
        'status_visibility' => 'Status visibility',
        'status_visibility_text' => 'Review filed date, court, and current case status at a glance.',
        'responsive_design' => 'Responsive design',
        'responsive_design_text' => 'Optimized layout for desktop, tablet, and smaller mobile screens.',
        'quick_search' => 'Quick search',
        'find_public_case' => 'Find a public case',
        'live_portal' => 'Live portal',
        'search_ready' => 'Search-ready',
        'search_hint' => 'Enter a case number, title keyword, court name, or case type to move directly into the public records list.',
        'search_public_records' => 'Search public records',
        'search_placeholder' => 'Case number, title, court, type...',
        'search_public_cases' => 'Search public cases',
        'helpful_tips' => 'Helpful tips',
        'tip_1' => 'Use the full case number for the most accurate result.',
        'tip_2' => 'Search by partial title if you do not know the full reference.',
        'tip_3' => 'Public results show basic case details only.',
        'card_1_title' => 'Clear information hierarchy',
        'card_1_text' => 'Key actions, search, and guidance are grouped so visitors can move through the portal with less friction.',
        'card_2_title' => 'Improved visual feedback',
        'card_2_text' => 'High-contrast buttons, stronger spacing, and card-based sections make the interface feel more trustworthy and modern.',
        'card_3_title' => 'Faster first action',
        'card_3_text' => 'Visitors land directly on the most important task, searching public cases, without getting lost in the interface.',
    ],

    'public_cases' => [
        'public_records' => 'Public records',
        'title' => 'Search and review public case listings.',
        'description' => 'Use the filters below to find published case records and quickly open the case summary page.',
        'results_shown' => 'Results shown',
        'on_this_page' => 'On this page',
        'search_state' => 'Search state',
        'filtered_results' => 'Filtered results',
        'all_public_cases' => 'All public cases',
        'keyword_applied' => 'Keyword applied',
        'no_filters_applied' => 'No filters applied',
        'search_public_cases' => 'Search public cases',
        'filter_results' => 'Filter results',
        'court' => 'Court',
        'filed' => 'Filed',
        'public_summary_available' => 'Public case summary available',
        'view_case' => 'View case',
        'no_public_cases_found' => 'No public cases found',
        'no_public_cases_text' => 'Try a different case number, title keyword, court name, or clear the current filter.',
        'no_public_cases_text_mobile' => 'Try updating your search terms or reset the filter to view more public case records.',
    ],
